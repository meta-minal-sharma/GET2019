...
public class StringOperations {
	...
	String reverse(String s)
	{
		...
		String rt = new StringBuffer(String.valueOf(c)).toString();   // converts character to string 
	...
	public static void main(String[] args) 
	{
		...
		StringOperations so=new StringOperations();
		 Scanner input = new Scanner(System.in);
	    	   ...
	    	   while(exit==0)
				{
					...
					switch(choice)
					{
						...
						case 2:
							System.out.println(" Reverse of the String is :: "+so.reverse(so.input()));
							break;

						case 3:
							System.out.println(" Toggled case of the String is :: "+so.toggleCase(so.input()));
							break;

						case 4:
							System.out.println(" Enter The String :: ");
							System.out.println(" Largest word in the string is :: "+so.largestWord(input.nextLine().split(" ")));
							break;
	       ...
	       {
	    	   System.out.println(" You enter invaild input please enter correct input ");
	       }
		}
