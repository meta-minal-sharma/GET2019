...
public class PolyTest {
	...
	public void test_Empty_Array() {
		   try { new Poly(new int[]{ }); }
		   catch (Exception e) { assertEquals("Empty Polynomial Array", e.getMessage());}
	   }
	...
	@Test
	   public void test_Add_Polyinomial() throws Exception{	
		   int returnedArrOperation[] = new Poly(new int[]{1,0,2,0,4}).addPoly(new Poly(new int[]{1,0,2,0,4}),new Poly(new int[]{0,1,0,5}));
	...
	@Test
	   public void test_Multiply_Polyinomial() throws Exception{	
		   int returnedArrOperation[] = new Poly(new int[]{1,0,2,0,4}).multiplyPoly(new Poly(new int[]{1,0,2,0,4}),new Poly(new int[]{0,1,0,5}));
